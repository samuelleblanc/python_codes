...
# Name:  
# 
#     KORUS_AOD_fine_coarse_autocorr_v2
#     
# Purpose:  
# 
...
for j in [0,1,2,3,4]:
    print legend_list[j], percentile_autocorr(autocorr_mm['MERRA_AOD'][j,1:],0.85),percentile_autocorr(autocorr_mm['aod0500'][j,1:],0.85)
...
me_all = pu.make_boxplot(arsn[fls['fl']],wvsn[fls['fl']],wvl_bins,wvl-3,y=1,alpha=0.5,
...
me_met1 = pu.make_boxplot(arsn[fls['fl_QA_met1']],wvsn[fls['fl_QA_met1']],wvl_bins,wvl,y=1,alpha=0.5,
                          label='Dynamic, AE={:1.2f}'.format(me_ae1),fliers_off=True,color='tab:orange',ax=ax2,tick_labels=False)
me_met2 = pu.make_boxplot(arsn[fls['fl_QA_met2']],wvsn[fls['fl_QA_met2']],wvl_bins,wvl+3,y=1,alpha=0.5,
                          label='Stagnation, AE={:1.2f}'.format(me_ae2),fliers_off=True,color='tab:green',ax=ax2,tick_labels=False)
me_met3 = pu.make_boxplot(arsn[fls['fl_QA_met3']],wvsn[fls['fl_QA_met3']],wvl_bins,wvl+6,y=1,alpha=0.5,
                          label='Extreme\npollution, AE={:1.2f}'.format(me_ae3),fliers_off=True,color='tab:red',ax=ax2,tick_labels=False)
me_met4 = pu.make_boxplot(arsn[fls['fl_QA_met4']],wvsn[fls['fl_QA_met4']],wvl_bins,wvl+9,y=1,alpha=0.5,
                          label='Blocking, AE={:1.2f}'.format(me_ae4),fliers_off=True,color='tab:purple',ax=ax2,tick_labels=False)
...
plt.tight_layout()
plt.savefig(fp+'plot/KORUS_AOD_spectra_hist_bymet_{}.png'.format(vv),dpi=600,transparent=True)
...
pu.make_boxplot(arsn[fls['fl']],wvlsn[fls['fl']],wvl_bins,wvl,y=1,alpha=0.5,
                label='All data, AE={:1.2f}'.format(ae_mean['all']),fliers_off=True,color='b',ax=ax[0])
pu.make_boxplot(arsn[fls['fl_0.5']],wvlsn[fls['fl_0.5']],wvl_bins,wvl+12,y=1,alpha=0.5,
                label='Below 0.5 km, AE={:1.2f}'.format(ae_mean['05']),
                fliers_off=True,color='k',ax=ax[0])
pu.make_boxplot(arsn[fls['fl_0.5_1']],wvlsn[fls['fl_0.5_1']],wvl_bins,wvl+10,y=1,alpha=0.5,
                label='0.5 km to 1 km, AE={:1.2f}'.format(ae_mean['05_1']),
                fliers_off=True,color='y',ax=ax[0])
pu.make_boxplot(arsn[fls['fl_1_2']],wvlsn[fls['fl_1_2']],wvl_bins,wvl+8,y=1,alpha=0.5,
                label='1 km to 2 km, AE={:1.2f}'.format(ae_mean['1_2']),
                fliers_off=True,color='m',ax=ax[0])
...
pu.make_boxplot(arsn[fls['fl_2_8']],wvlsn[fls['fl_2_8']],wvl_bins,wvl+4,y=1,alpha=0.5,
                label='2 km to 8 km, AE={:1.2f}'.format(ae_mean['2_8']),
                fliers_off=True,color='r',ax=ax[0])
pu.make_boxplot(arsn[fls['fl_8']],wvlsn[fls['fl_8']],wvl_bins,wvl+2,y=1,alpha=0.5,
                label='Above 8 km, AE={:1.2f}'.format(ae_mean['8']),fliers_off=True,color='g',ax=ax[0])
...
pu.make_boxplot(ar['AOD0380'][ar['fl']],ar['GPS_Alt'][ar['fl']],
                bins,pos+50.0,color='blue',alpha=0.5,y=0,vert=False,label='380 nm',fliers_off=True,ax=ax[1])
pu.make_boxplot(ar['AOD0501'][ar['fl']],ar['GPS_Alt'][ar['fl']],
                bins,pos,color='green',alpha=0.5,y=0,vert=False,label='501 nm',fliers_off=True,ax=ax[1])
pu.make_boxplot(ar['AOD0865'][ar['fl']],ar['GPS_Alt'][ar['fl']],
                bins,pos-50.0,color='red',alpha=0.5,y=0,vert=False,label='865 nm',fliers_off=True,ax=ax[1])
...
plt.savefig(fp+'plot/KORUS_AOD_wvl_by_alt_{}.png'.format(vv),dpi=600,transparent=True)
plt.savefig(fp+'plot/KORUS_AOD_wvl_by_alt_{}.pdf'.format(vv),dpi=600,transparent=True)
plt.savefig(fp+'plot/KORUS_AOD_wvl_by_alt_{}.eps'.format(vv),dpi=600,transparent=True)
plt.savefig(fp+'plot/KORUS_AOD_wvl_by_alt_{}.svg'.format(vv),dpi=600,transparent=True)
